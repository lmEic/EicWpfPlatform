...
namespace ZhuiFengLib.Message
{
    ...
    public static class Message
    {
        ...
        public static void MessageInfo(object msg)
        {
            MessageBox.Show(msg.ToString(), "系统提示", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
